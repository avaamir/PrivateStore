...
import com.amir.ir.privatestore.databinding.ItemProductHorizontalBinding
import com.amir.ir.privatestore.models.Product
import com.amir.ir.privatestore.ui.listeners.ProductInteraction

class ProductHorizontalAdapter(private val interaction: ProductInteraction? = null) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val binding = DataBindingUtil.inflate<ItemProductHorizontalBinding>(
            layoutInflater,
    ...
    inner class ProductViewHolder(private val mBinding: ItemProductHorizontalBinding) :
