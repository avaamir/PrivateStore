...
import com.amir.ir.privatestore.databinding.ItemProductGridBinding
import com.amir.ir.privatestore.models.Product
import com.amir.ir.privatestore.ui.listeners.ProductInteraction

class ProductGridAdapter(private val interaction: ProductInteraction? = null) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val binding = DataBindingUtil.inflate<ItemProductGridBinding>(
            layoutInflater,
    ...
    inner class ProductViewHolder(private val mBinding: ItemProductGridBinding) :
